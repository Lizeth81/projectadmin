...
@Component({
  selector: 'app-proyectofinaldir',
  templateUrl: './proyectofinaldir.component.html',
  styleUrls: ['./proyectofinaldir.component.css']
})
export class ProyectofinaldirComponent {
  value?: string;
