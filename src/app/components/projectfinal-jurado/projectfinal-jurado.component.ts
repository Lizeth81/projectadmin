...
@Component({
  selector: 'app-projectfinal-jurado',
  templateUrl: './projectfinal-jurado.component.html',
  styleUrls: ['./projectfinal-jurado.component.css']
})
export class ProjectfinalJuradoComponent {
