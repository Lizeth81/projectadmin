...
@Component({
  selector: 'app-proposedgrade-jurado',
  templateUrl: './proposedgrade-jurado.component.html',
  styleUrls: ['./proposedgrade-jurado.component.css']
})
export class ProposedgradeJuradoComponent {
  value?: string;
