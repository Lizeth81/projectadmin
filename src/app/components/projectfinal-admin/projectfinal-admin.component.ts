...
@Component({
  selector: 'app-projectfinal-admin',
  templateUrl: './projectfinal-admin.component.html',
  styleUrls: ['./projectfinal-admin.component.css']
})
export class ProjectfinalAdminComponent {
  value?: string;
