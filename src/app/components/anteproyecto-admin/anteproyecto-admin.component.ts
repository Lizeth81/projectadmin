...
@Component({
  selector: 'app-anteproyecto-admin',
  templateUrl: './anteproyecto-admin.component.html',
  styleUrls: ['./anteproyecto-admin.component.css']
})
export class AnteproyectoAdminComponent {
  value?: string;
