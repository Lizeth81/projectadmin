...
@Component({
  selector: 'app-anteproyecto-director',
  templateUrl: './anteproyecto-director.component.html',
  styleUrls: ['./anteproyecto-director.component.css']
})
export class AnteproyectoDirectorComponent {
  value?: string;
